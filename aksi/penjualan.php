...
if($_POST){
    if($_POST['aksi']=='tambah-keranjang-bybarcode'){
        ...
        if(mysqli_query($koneksi,$sql1)){
            ...
            $sql2="SELECT MAX(PenjualanID) AS LastID FROM
            penjualan";
            ...
            // Menyimpan Data Folder Yang Dibeli ke tabel detailpenjualan yang diambil dari tabel keranjang
            $sql3="SELECT keranjang.*,produk.Harga FROM
            keranjang,produk WHERE keranjang.ProdukID=produk.
            ProdukID AND id_user=$id_user";
            // echo $sql3;
            ...
            while($keranjang=mysqli_fetch_array($query3)){
                ...
                $sql4="INSERT INTO detailpenjualan(DetailID,
                PenjualanID,ProdukID,JumlahProduk,Harga) value
...
if($_GET){
     ...
     if ($_GET['aksi']=='hapus-keranjang'){
        ...
        $id_user=$_SESSION['id'];
        $sql="DELETE FROM keranjang WHERE ProdukID=$ProdukID"; 
     ...
     if ($_GET['aksi']=='hapus'){
        ...
        $sql1="DELETE FROM penjualan WHERE
        PenjualanID=$PenjualanID"; 
        mysqli_query($koneksi,$sql1);

        $sql2="DELETE FROM detailpenjualan WHERE
        PenjualanID=$PenjualanID"; 
        mysqli_query($koneksi,$sql2);
